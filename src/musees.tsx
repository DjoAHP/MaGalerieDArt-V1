        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white">
          ...
          <div className="max-w-6xl mx-auto py-20">
            ...
            <div className="mt-8">
              ...
              />
              <p className="text-gray-300">
                La Galerie Borghèse est l’une des galeries d’art les plus
                connues au monde. Elle est située à Rome, en Italie, et
                installée dans l’ancienne Villa Borghese Pinciana.
              </p>
              <a
            ...
            <div className="mt-8">
              ...
              />
              <p className="text-gray-300">
                La National Gallery (en français, la Galerie nationale) fondée
                en 1824, est un musée situé à Londres en Angleterre et occupant
                le nord de Trafalgar Square depuis 1838. Elle détient un
                patrimoine artistique composé principalement de peintures datant
                de 1250 à 1900, les œuvres plus récentes étant abritées à la
                Tate Modern. La collection permanente de 2 300 peintures
                appartient à l'État britannique et son accès est gratuit. Seules
                les expositions temporaires sont soumises à un prix d'entrée. La
                Gallery est un « organisme public non ministériel » rattaché au
            ...
            <div className="mt-8">
              ...
              />
              <p className="text-gray-300">
                La Galerie des Offices est un important musée d'art situé à côté
                de la Piazza della Signoria dans le centre historique de
                Florence en Toscane , en Italie. L'un des musées italiens les
                plus importants et les plus visités, il est également l'un des
                plus grands et des plus connus au monde et abrite une collection
                d'œuvres inestimables, notamment de la période de la Renaissance
                italienne .
              </p>
              <a
